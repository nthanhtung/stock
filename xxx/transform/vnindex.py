...
df_source = pd.read_csv("data/cophieu68/excel_^vnindex.csv")
df_source.columns
...
df_target = pd.read_csv("data/stock_price/stock_price_2021.csv")
df_target.columns
...
df_vnindex.to_csv("data/stock_price/0-vnindex.csv")